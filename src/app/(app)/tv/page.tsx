...
import { getTVGenres, getWatchProviders, type DiscoverFilters, type TmdbMedia } from "@/lib/tmdb";
...
export default async function TVPage({
  ...
  const [genres, providers, browse] = await Promise.all([
    ...
    runBrowseQuery({ mediaType: "tv", page, filters, hideAvailable, ratingFilter, session })
