// Instant loading skeleton for the TV detail page. The route fetches TMDB
// details + credits + suggestions + season/availability lookups before render,
// so a fallback keeps navigation feeling immediate.
  ...
  return (
    <div className="animate-pulse">
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        {/* Seasons list */}
        <div className="flex flex-col gap-2" style={{ marginTop: 40 }}>
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="rounded-lg"
              style={{ height: 56, background: "var(--ds-bg-2)" }}
            />
          ))}
        </div>
      </div>
