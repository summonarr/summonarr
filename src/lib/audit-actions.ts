...
export const ACTION_LABELS: Record<AuditAction, ActionLabel> = {
  ...
  USER_DEACTIVATE:       { label: "User Disabled",             color: "bg-red-900/50 text-red-400",            icon: "delete" },
  USER_REACTIVATE:       { label: "User Re-enabled",           color: "bg-green-900/50 text-green-400",        icon: "role" },
  USER_PURGE:            { label: "User Data Purged",          color: "bg-red-900/50 text-red-400",            icon: "delete" },
  ...
  CONTENT_REPORT:        { label: "Content Reported",          color: "bg-orange-900/50 text-orange-400",      icon: "issue" },
  ...
  SERVER_USER_LINK:      { label: "Server User Re-linked",     color: "bg-blue-900/50 text-blue-400",          icon: "role" },
