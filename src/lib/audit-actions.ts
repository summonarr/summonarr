...
export const ACTION_LABELS: Record<AuditAction, ActionLabel> = {
  REQUEST_APPROVE:       { label: "Request Approved",         color: "bg-green-500/15 text-green-400",         icon: "approve" },
  REQUEST_DECLINE:       { label: "Request Declined",         color: "bg-red-500/15 text-red-400",             icon: "decline" },
  REQUEST_DELETE:        { label: "Request Deleted",          color: "bg-red-500/15 text-red-400",             icon: "delete" },
  REQUEST_ON_BEHALF:     { label: "Request On Behalf",        color: "bg-sky-500/15 text-sky-400",           icon: "approve" },
  BATCH_REQUEST_DECLINE: { label: "Batch Decline (Permanent)", color: "bg-red-500/15 text-red-400",            icon: "decline" },
  USER_CREATE:           { label: "User Created",             color: "bg-green-500/15 text-green-400",         icon: "role" },
  USER_ROLE_CHANGE:      { label: "Role Changed",             color: "bg-sky-500/15 text-sky-400",           icon: "role" },
  USER_PERMISSIONS_CHANGE: { label: "Permissions Changed",    color: "bg-sky-500/15 text-sky-400",           icon: "role" },
  USER_DELETE:           { label: "User Deleted",              color: "bg-red-500/15 text-red-400",            icon: "delete" },
  USER_DEACTIVATE:       { label: "User Disabled",             color: "bg-red-500/15 text-red-400",            icon: "delete" },
  USER_REACTIVATE:       { label: "User Re-enabled",           color: "bg-green-500/15 text-green-400",        icon: "role" },
  USER_PURGE:            { label: "User Data Purged",          color: "bg-red-500/15 text-red-400",            icon: "delete" },
  SETTINGS_CHANGE:       { label: "Settings Changed",          color: "bg-yellow-500/15 text-yellow-400",      icon: "settings" },
  LIBRARY_SYNC:          { label: "Library Synced",            color: "bg-purple-500/15 text-purple-400",      icon: "sync" },
  ISSUE_STATUS_CHANGE:   { label: "Issue Updated",             color: "bg-orange-500/15 text-orange-400",      icon: "issue" },
  ISSUE_CLAIM:           { label: "Issue Claimed",             color: "bg-orange-500/15 text-orange-400",      icon: "issue" },
  ISSUE_UNCLAIM:         { label: "Issue Unclaimed",           color: "bg-zinc-700/50 text-zinc-400",          icon: "issue" },
  ISSUE_DELETE:          { label: "Issue Deleted",             color: "bg-red-500/15 text-red-400",            icon: "delete" },
  CONTENT_REPORT:        { label: "Content Reported",          color: "bg-orange-500/15 text-orange-400",      icon: "issue" },
  MAINTENANCE_TOGGLE:    { label: "Maintenance Toggle",        color: "bg-yellow-500/15 text-yellow-400",      icon: "maintenance" },
  BACKUP_EXPORT:         { label: "Backup Exported",           color: "bg-indigo-600/15 text-indigo-400",      icon: "export" },
  BACKUP_IMPORT:         { label: "Backup Imported",           color: "bg-indigo-600/15 text-indigo-400",      icon: "import" },
  AUDIT_LOG_EXPORT:      { label: "Audit Log Exported",        color: "bg-indigo-600/15 text-indigo-400",      icon: "export" },
  AUTH_LOGIN:            { label: "Login",                     color: "bg-emerald-500/15 text-emerald-400",    icon: "login" },
  ...
  PLAY_HISTORY_DELETE:   { label: "Play History Deleted",      color: "bg-red-500/15 text-red-400",            icon: "delete" },
  PLAY_HISTORY_EXPORT:   { label: "Play History Exported",     color: "bg-indigo-600/15 text-indigo-400",      icon: "export" },
  VOTE_DISMISS_ALL:      { label: "Votes Dismissed",           color: "bg-zinc-700/50 text-zinc-400",          icon: "approve" },
  FIX_MATCH:             { label: "Library Match Fixed",       color: "bg-sky-500/15 text-sky-400",          icon: "sync" },
  SERVER_USERS_BULK:     { label: "Bulk Media-Server Action",  color: "bg-sky-500/15 text-sky-400",          icon: "role" },
  SERVER_USER_LINK:      { label: "Server User Re-linked",     color: "bg-sky-500/15 text-sky-400",          icon: "role" },
