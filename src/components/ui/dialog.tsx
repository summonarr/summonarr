...
function DialogPopup({
  ...
  return (
    <DialogPrimitive.Popup
      ...
      className={cn(
        "fixed left-1/2 top-1/2 z-50 flex max-h-[calc(100dvh-2rem)] w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900 shadow-[var(--ds-shadow-lg)] outline-none",
