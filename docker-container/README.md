...
| `SUMMONARR_VERSION`            | image tag; default `latest`      | Pin the GHCR image tag. Example: `SUMMONARR_VERSION=0.27.0` (no `v` — the published tags are bare semver).                                                                                                   |
